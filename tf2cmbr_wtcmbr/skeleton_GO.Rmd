...
#The `nullp()` function is finding the null distribution.  The nullp plots the fit of the null distribution to the data.  Usually you will see that length does in fact bias your results. 
